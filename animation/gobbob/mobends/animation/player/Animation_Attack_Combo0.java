...
public class Animation_Attack_Combo0 {
   public static void animate(EntityPlayer player, ModelBendsPlayer model, Data_Player data) {
      ...
      if (player.func_71045_bC() != null && data.ticksAfterPunch < 4.0F & player.func_71045_bC().func_77973_b() instanceof ItemSword) {
      ...
      ((ModelRendererBends)model.field_78116_c).pre_rotation.setSmoothX(-model.field_78115_e.field_78795_f, 0.9F);
      ((ModelRendererBends)model.field_78116_c).pre_rotation.setSmoothY(-model.field_78115_e.field_78796_g - 30.0F, 0.9F);
      ...
      ((ModelRendererBends)model.field_78112_f).rotation.setSmoothX(60.0F - armSwing * 180.0F, 3.0F);
      ((ModelRendererBends)model.field_78112_f).rotation.setSmoothY(0.0F, 0.9F);
      ...
      if (data.motion.x == 0.0F & data.motion.z == 0.0F) {
         ...
         ((ModelRendererBends)model.field_78123_h).rotation.setSmoothY(0.0F, 0.3F);
         ...
         ((ModelRendererBends)model.field_78115_e).rotation.setSmoothY(-70.0F * armSwing, 0.9F);
      }
