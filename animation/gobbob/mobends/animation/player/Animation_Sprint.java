...
public class Animation_Sprint extends Animation {
   ...
   public void animate(EntityLivingBase argEntity, ModelBase argModel, EntityData argData) {
      ...
      ((ModelRendererBends)model.field_78112_f).rotation.setSmoothX(1.1F * (float)((double)(MathHelper.func_76134_b(model.armSwing * 0.6662F + 3.1415927F) * 2.0F * model.armSwingAmount * 0.5F) / 3.141592653589793D * 180.0D));
      ((ModelRendererBends)model.field_78113_g).rotation.setSmoothX(1.1F * (float)((double)(MathHelper.func_76134_b(model.armSwing * 0.6662F) * 2.0F * model.armSwingAmount * 0.5F) / 3.141592653589793D * 180.0D));
      ...
      ((ModelRendererBends)model.bipedLeftForeArm).rotation.setSmoothX((float)(var > 1.0F ? -10 : -45), 0.3F);
      ((ModelRendererBends)model.bipedRightForeArm).rotation.setSmoothX((float)(var > 1.0F ? -45 : -10), 0.3F);
      float var2 = (float)Math.cos((double)(model.armSwing * 0.6662F)) * -40.0F;
      float var3 = (float)(Math.cos((double)(model.armSwing * 0.6662F * 2.0F)) * 0.5D + 0.5D) * 20.0F;
