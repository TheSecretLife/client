...
public class GuiContainerC3 extends GuiContainer {
   ...
   public void func_73866_w_() {
      ...
      this.name.func_146180_a("กรอกชื่อร้าน");
   }
   ...
   public GuiContainerC3(IInventory playerInv, TileC3 te) {
      super(new ContainerC3(playerInv, te));
