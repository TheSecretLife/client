...
public class RenderBlockNPC2 extends TileEntitySpecialRenderer {
   public static final sagaobj model = (sagaobj)SagaModelLoader.loadModel(new ResourceLocation("cabalaccessorys:models/npc/panda/panda.saga"));
   public static final ResourceLocation texture = new ResourceLocation("cabalaccessorys:models/npc/panda/panda-fire.png");

   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      this.doRender((TileC2)te, x, y, z, scale);
   }

   public void doRender(TileC2 te, double x, double y, double z, float scale) {
      float size = 0.14F;
      GL11.glPushMatrix();
      GL11.glDisable(2896);
      GL11.glDisable(2884);
