...
public class BlockC2 extends BlockContainer {
   public BlockC2() {
   ...
   public void func_149689_a(World par1World, int par2, int par3, int par4, EntityLivingBase placer, ItemStack stack) {
      ...
      ((TileC2)par1World.func_147438_o(par2, par3, par4)).setNamenpc("ร้านขายของ");
      if (stack.func_82837_s()) {
         ((TileC2)par1World.func_147438_o(par2, par3, par4)).setCustomName(stack.func_82833_r());
      }
   ...
   public boolean func_149727_a(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
      if (!world.field_72995_K) {
         if (player.field_71075_bZ.field_75098_d && !player.func_70093_af()) {
            player.openGui(Main.instance, Main.GUI_SETITEM2, world, x, y, z);
         } else if (player.field_71075_bZ.field_75098_d && player.func_70093_af()) {
            player.openGui(Main.instance, Main.GUI_NPCPLAYER2, world, x, y, z);
         } else {
            player.openGui(Main.instance, Main.GUI_NPCPLAYER2, world, x, y, z);
         }
      }
