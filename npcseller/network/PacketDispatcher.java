...
import npcseller.network.server.onServergetPoints;
...
public class PacketDispatcher {
   ...
   public static final void registerPackets() {
      registerMessage(onServergetItem.class);
      registerMessage(onServersetname.class);
      registerMessage(onServergetPoints.class);
   }
   ...
   static {
      dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel("npcseller");
      packetId = 0;
   }
}
