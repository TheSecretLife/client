...
public class localplayer extends localmain {
   ...
   public localplayer(EntityPlayer player) {
      ...
      save.get(player).saveNBTData(data);
   }
   ...
   public static class Handler implements IMessageHandler {
      ...
      public IMessage onMessage(localplayer message, MessageContext ctx) {
         World theWorld = Minecraft.func_71410_x().field_71441_e;
         EntityPlayer player = getEntityByID(localplayer.entityID, theWorld);
         save.get(player).loadNBTData(localplayer.data);
         return null;
      }
