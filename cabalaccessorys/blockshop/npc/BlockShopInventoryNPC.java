...
public class BlockShopInventoryNPC implements IInventory {
   private final String name = "";
   private final String tagName = "BlockShopOwnerInvNPC";
   ...
   public void writeToNBT(NBTTagCompound compound) {
      ...
      compound.func_74782_a("BlockShopOwnerInvNPC", items);
   }

   public void readFromNBT(NBTTagCompound compound) {
      NBTTagList items = compound.func_150295_c("BlockShopOwnerInvNPC", compound.func_74732_a());
