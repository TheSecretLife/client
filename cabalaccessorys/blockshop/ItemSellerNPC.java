...
public class ItemSellerNPC extends Item {
   public ItemSellerNPC(String unlocalizedName) {
   ...
   public void func_77624_a(ItemStack st, EntityPlayer pl, List lt, boolean bl) {
      lt.add("§fใช้เรียก NPC ออกมาฝากขายของ");
      lt.add("§fเสียภาษี 10% จากราคาไอเทมที่ขาย");
   }
