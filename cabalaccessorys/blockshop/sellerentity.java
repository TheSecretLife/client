...
import cabalaccessorys.blockbuy.BlockBuyInventory;
...
public class sellerentity extends EntityTameable {
   public final BlockBuyInventory BS = new BlockBuyInventory();
   public final BlockShopInventory SW = new BlockShopInventory();
   World world = null;
   public int price1 = 0;
   public int price2 = 0;
   public int price3 = 0;
   ...
   public sellerentity spawnBabyAnimal(EntityAgeable cs) {
      return new sellerentity(this.field_70170_p);
   }
   ...
   public boolean func_70085_c(EntityPlayer player) {
      ...
      if (!player.field_70170_p.field_72995_K && itemstack == null) {
         ...
         if (this.func_70909_n() && player.func_110124_au().toString().equalsIgnoreCase(this.getOwnerName())) {
            ...
            player.openGui(Start.instance, Start.BsG, player.func_130014_f_(), (int)player.field_70165_t, (int)player.field_70163_u, (int)player.field_70161_v);
            ...
            player.openGui(Start.instance, Start.BBSGUI, player.func_130014_f_(), (int)player.field_70165_t, (int)player.field_70163_u, (int)player.field_70161_v);
         } else {
   ...
   public void func_70636_d() {
      if (!this.field_70170_p.field_72995_K) {
         ...
         if (sell1 == null && sell2 == null && sell3 == null && sell4 == null && sell5 == null && sell6 == null) {
            this.opensell = false;
            this.func_94058_c("§f[§cปิดร้าน§f] §z" + this.ownername);
            if (this.func_70902_q() != null && this.money > 0) {
               EntityPlayer player = (EntityPlayer)this.func_70902_q();
               PlayerData px = PlayerData.get(player);
               px.Money += this.money - this.money / 10;
               int balance = this.money - this.money / 10;
               this.money = 0;
               player.func_145747_a(new ChatComponentText("§6ของในร้าน NPC ขายหมดแล้วเก็บร้านอัตโนมัติ"));
               player.func_145747_a(new ChatComponentText("§aรับเงินจาก NPC แล้ว จำนวน §e" + balance + " §aGold"));
               player.func_145747_a(new ChatComponentText("§aเสียภาษี §c" + this.money / 10 + " §aGold"));
               this.func_70106_y();
               px.npcshop = false;
            }
         }
