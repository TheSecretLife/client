...
public class BlockBuySlotNPC extends Slot {
   public int field_75225_a;
   public EntityPlayer player;

   BlockBuySlotNPC(BlockBuyInventoryNPC bS, int par3, int par4, int par5, EntityPlayer player) {
      super(bS, par3, par4, par5);
      this.player = player;
