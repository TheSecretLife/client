...
public class BlockBuyInventoryNPC implements IInventory {
   private final String name = "";
   private final String tagName = "SSSa";
   public static final int SlotNum = 36;
   ...
   public void writeToNBT(NBTTagCompound compound) {
      ...
      for(int i = 0; i < this.func_70302_i_(); ++i) {
         if (this.func_70301_a(i) != null) {
            ...
            item.func_74774_a("BBS", (byte)i);
            this.func_70301_a(i).func_77955_b(item);
            items.func_74742_a(item);
         }
      }

      compound.func_74782_a("SSSa", items);
   }

   public void readFromNBT(NBTTagCompound compound) {
      NBTTagList items = compound.func_150295_c("SSSa", compound.func_74732_a());

      for(int i = 0; i < items.func_74745_c(); ++i) {
         NBTTagCompound item = items.func_150305_b(i);
         byte slot = item.func_74771_c("BBS");
