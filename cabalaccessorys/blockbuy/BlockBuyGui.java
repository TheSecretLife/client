...
public class BlockBuyGui extends GuiContainer {
   EntityPlayer Player = null;
   sellerentity Te = null;
   private float xSize_lo;
   private float ySize_lo;
   private static final ResourceLocation iconLocation = new ResourceLocation("cabalaccessorys:textures/GuiBUY.png");
   private final BlockBuyInventory inventory;

   public BlockBuyGui(EntityPlayer player, sellerentity te, InventoryPlayer inventoryPlayer, BlockBuyInventory inventoryCustom) {
      super(new BlockBuyData(player, inventoryPlayer, inventoryCustom));
   ...
   public void func_73863_a(int mouseX, int mouseY, float f) {
      ...
      this.field_146292_n.add(new GuiButton(0, this.field_147003_i + 125 - 71 - 54, this.field_147009_r + 43 - 36, 20, 15, "ซื้อ"));
      this.field_146292_n.add(new GuiButton(1, this.field_147003_i + 125 - 71 - 54, this.field_147009_r + 43 - 18, 20, 15, "ซื้อ"));
      this.field_146292_n.add(new GuiButton(2, this.field_147003_i + 125 - 71 - 54, this.field_147009_r + 43, 20, 15, "ซื้อ"));
   ...
   protected void func_146284_a(GuiButton button) {
      ...
      if (button.field_146127_k == 0) {
         if (sell1 != null) {
            Start.networkChannel.sendToServer(new BlockBuyNewPacket(1));
            p.func_71053_j();
         } else {
         ...
         if (sell2 != null) {
            Start.networkChannel.sendToServer(new BlockBuyNewPacket(2));
            p.func_71053_j();
         } else {
         ...
         if (sell3 != null) {
            Start.networkChannel.sendToServer(new BlockBuyNewPacket(3));
            p.func_71053_j();
         } else {
         ...
         if (sell4 != null) {
            Start.networkChannel.sendToServer(new BlockBuyNewPacket(4));
            p.func_71053_j();
         } else {
         ...
         if (sell5 != null) {
            Start.networkChannel.sendToServer(new BlockBuyNewPacket(5));
            p.func_71053_j();
         } else {
         ...
         if (sell6 != null) {
            Start.networkChannel.sendToServer(new BlockBuyNewPacket(6));
            p.func_71053_j();
         } else {
