...
public class RenderWeaponB implements IItemRenderer {
   ...
   public void renderBigItem(EntityLivingBase entity, ItemStack stack) {
      ...
      if (icon != null) {
         ...
         if (stack != null) {
            ...
            GL11.glEnable(3042);
            float f7 = 0.76F;
            GL11.glColor4f(20.0F, 20.0F, 20.0F, 0.3F);
            ...
            ItemRenderer.func_78439_a(tessellator, 0.0F, 0.0F, 1.0F, 2.5F, 256, 256, 0.0625F);
            GL11.glPopMatrix();
