...
public class RenderWeaponC implements IItemRenderer {
   ...
   public void renderBigItem(EntityLivingBase entity, ItemStack stack) {
      ...
      if (icon != null) {
         ...
         if (stack != null) {
            ...
            ItemRenderer.func_78439_a(tessellator, 0.0F, 0.0F, 2.0F, 5.5F, 256, 256, 0.0625F);
            GL11.glPopMatrix();
            GL11.glPushMatrix();
            GL11.glScalef(f8, f8, f8);
            GL11.glTranslatef(f9, 0.0F, 0.0F);
            GL11.glRotatef(-50.0F, 0.0F, 0.0F, 1.0F);
            ItemRenderer.func_78439_a(tessellator, 2.0F, 5.5F, 0.0F, 0.0F, 256, 256, 0.0625F);
            GL11.glPopMatrix();
