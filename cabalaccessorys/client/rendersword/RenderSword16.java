...
public class RenderSword16 implements IItemRenderer {
   private String modelfile = "cabalaccessorys:models/newweapon/5.saga";
   private String texturemodelfile = "cabalaccessorys:models/newweapon/5.png";
   ...
   public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
      if (this.modelobj == null) {
         ...
         if (type == ItemRenderType.EQUIPPED) {
            GL11.glPushMatrix();
            GL11.glTranslatef(1.2F, 0.15F, 0.02F);
