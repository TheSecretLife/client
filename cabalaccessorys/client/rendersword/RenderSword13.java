...
public class RenderSword13 implements IItemRenderer {
   private String modelfile = "cabalaccessorys:models/newweapon/2.saga";
   private String texturemodelfile = "cabalaccessorys:models/newweapon/2.png";
   ...
   public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
      if (this.modelobj == null) {
         ...
         if (type == ItemRenderType.EQUIPPED) {
            GL11.glPushMatrix();
            GL11.glTranslatef(1.1F, 0.0F, 0.05F);
