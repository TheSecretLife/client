...
public class minv implements IInventory {
   private final String tagName = "mgus";
   ...
   public void writeToNBT(NBTTagCompound compound) {
      ...
      for(int i = 0; i < this.func_70302_i_(); ++i) {
         if (this.func_70301_a(i) != null) {
            ...
            item.func_74774_a("mgus" + this.guild + this.page, (byte)i);
            this.func_70301_a(i).func_77955_b(item);
            items.func_74742_a(item);
         }
      }

      compound.func_74782_a("mgus" + this.guild + this.page, items);
   }

   public void readFromNBT(NBTTagCompound compound) {
      NBTTagList items = compound.func_150295_c("mgus" + this.guild + this.page, compound.func_74732_a());

      for(int i = 0; i < items.func_74745_c(); ++i) {
         NBTTagCompound item = items.func_150305_b(i);
         byte slot = item.func_74771_c("mgus" + this.guild + this.page);
