...
public class RenderSetArmor5 extends ModelBendsPlayer {
   public static final IModelCustom model = SagaModelLoader.loadModel(new ResourceLocation("cabalaccessorys", "models/newarmor/armor5.saga"));
   public static final ResourceLocation texture = new ResourceLocation("cabalaccessorys", "models/newarmor/armor5.png");
   ...
   public static void rendermodel(ModelBendsPlayer part, EntityPlayer player) {
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(-0.001F, 0.01F, -0.005F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(0.0F, 0.03F, 0.005F);
