...
public class RenderSetArmor3 extends ModelBendsPlayer {
   public static final IModelCustom model = SagaModelLoader.loadModel(new ResourceLocation("cabalaccessorys", "models/newarmor/armor3.saga"));
   public static final ResourceLocation texture = new ResourceLocation("cabalaccessorys", "models/newarmor/armor3.png");
   ...
   public static void rendermodel(ModelBendsPlayer part, EntityPlayer player) {
      ...
      rotationpart(part.field_78115_e);
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(0.0F, 0.71F, 0.0F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(-0.001F, -0.0F, 0.003F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(0.005F, -0.01F, 0.0F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(-0.002F, -0.0F, 0.003F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(0.0F, 0.03F, 0.01F);
