...
public class RenderSetArmor9 extends ModelBendsPlayer {
   public static final IModelCustom model = SagaModelLoader.loadModel(new ResourceLocation("cabalaccessorys", "models/newarmor/set2/armor4.saga"));
   public static final ResourceLocation texture = new ResourceLocation("cabalaccessorys", "models/newarmor/set2/armor4.png");
   ...
   public static void rendermodel(ModelBendsPlayer part, EntityPlayer player) {
      ...
      if (player.func_70096_w().func_75681_e(26).split(",")[1].equalsIgnoreCase("off")) {
         ...
         GL11.glTranslatef(0.0F, 0.07F, -0.05F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(-0.007F, 0.002F, -0.007F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(-0.002F, 0.0F, -0.005F);
