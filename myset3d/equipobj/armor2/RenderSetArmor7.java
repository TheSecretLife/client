package myset3d.equipobj.armor2;
...
public class RenderSetArmor7 extends ModelBendsPlayer {
   public static final IModelCustom model = SagaModelLoader.loadModel(new ResourceLocation("cabalaccessorys", "models/newarmor/set2/armor2.saga"));
   public static final ResourceLocation texture = new ResourceLocation("cabalaccessorys", "models/newarmor/set2/armor2.png");
   ...
   public static void rendermodel(ModelBendsPlayer part, EntityPlayer player) {
      ...
      if (player.func_70096_w().func_75681_e(26).split(",")[1].equalsIgnoreCase("off")) {
         ...
         GL11.glScalef(size + 0.13F, size + 0.13F, size + 0.13F);
         GL11.glTranslatef(0.0F, 0.08F, -0.04F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(-0.001F, 0.002F, -0.002F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(0.005F, 0.0F, 0.0F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(-0.002F, 0.0F, -0.002F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(0.0F, 0.01F, 0.005F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(0.0F, 0.013F, 0.0F);
