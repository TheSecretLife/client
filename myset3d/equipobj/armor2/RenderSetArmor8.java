...
public class RenderSetArmor8 extends ModelBendsPlayer {
   public static final IModelCustom model = SagaModelLoader.loadModel(new ResourceLocation("cabalaccessorys", "models/newarmor/set2/armor3.saga"));
   public static final ResourceLocation texture = new ResourceLocation("cabalaccessorys", "models/newarmor/set2/armor3.png");
   ...
   public static void rendermodel(ModelBendsPlayer part, EntityPlayer player) {
      ...
      if (player.func_70096_w().func_75681_e(26).split(",")[1].equalsIgnoreCase("off")) {
         ...
         GL11.glScalef(size + 0.15F, size + 0.15F, size + 0.15F);
      ...
      GL11.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
      GL11.glTranslatef(-0.001F, 0.002F, -0.005F);
