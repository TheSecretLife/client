...
public class blockLemonPlant extends BlockContainer {
   public blockLemonPlant() {
      super(Material.field_151571_B);
      this.func_149676_a(0.4F, 0.0F, 0.4F, 0.6F, 1.0F, 0.6F);
      this.func_149658_d("fantasyland:blockLemon");
   ...
   public boolean func_149727_a(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
      ...
      if (!par1World.field_72995_K) {
         if (par1World.func_72805_g(par2, par3, par4) == 5) {
            ItemStack item = new ItemStack(ReqFarmItem.Lemon);
