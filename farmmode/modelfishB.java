...
public class modelfishB extends ModelBase {
   ...
   public modelfishB() {
      ...
      this.tail_1 = new ModelRenderer(this, 43, 0);
      this.tail_1.func_78790_a(-0.5F, -8.0F, 3.0F, 1, 6, 4, scale);
      this.tail_1.func_78793_a(-2.5F, 15.0F, 2.5F);
      this.tail_1.field_78795_f = -0.34907F;
      ...
      this.tail_2 = new ModelRenderer(this, 54, 0);
      this.tail_2.func_78790_a(-0.5F, 2.0F, 3.0F, 1, 6, 4, scale);
      this.tail_2.func_78793_a(-2.5F, 15.0F, 2.5F);
      this.tail_2.field_78795_f = 0.34907F;
      this.dorsalfin = new ModelRenderer(this, 52, 21);
      this.dorsalfin.func_78790_a(-3.0F, 0.0F, 0.0F, 1, 6, 5, scale);
      this.dorsalfin.func_78793_a(0.0F, 9.0F, -4.0F);
      this.dorsalfin.field_78795_f = -0.20944F;
      this.fin_right = new ModelRenderer(this, 22, 27);
      this.fin_right.func_78790_a(-5.0F, 0.0F, 0.0F, 5, 1, 4, scale);
      this.fin_right.func_78793_a(-4.5F, 16.0F, -6.0F);
      this.fin_right.field_78795_f = 0.22689F;
      this.fin_left = new ModelRenderer(this, 22, 20);
      this.fin_left.func_78790_a(0.0F, 0.0F, 0.0F, 5, 1, 4, scale);
      this.fin_left.func_78793_a(0.0F, 16.0F, -6.0F);
      ...
      this.left_whisker = new ModelRenderer(this, 17, 10);
      this.left_whisker.func_78790_a(0.0F, 0.0F, 0.0F, 3, 1, 1, scale);
      this.left_whisker.func_78793_a(-1.0F, 15.0F, -12.0F);
      this.left_whisker.field_78796_g = -0.5236F;
      this.right_whisker = new ModelRenderer(this, 17, 13);
      this.right_whisker.func_78790_a(-3.0F, 0.0F, 0.0F, 3, 1, 1, scale);
      this.right_whisker.func_78793_a(-3.5F, 15.0F, -12.0F);
      this.right_whisker.field_78796_g = 0.5236F;
      this.tail2 = new ModelRenderer(this, 37, 15);
      this.tail2.func_78790_a(-1.5F, -2.0F, 1.5F, 3, 4, 4, scale);
      this.tail2.func_78793_a(-2.5F, 15.0F, 2.5F);
      this.right_gill = new ModelRenderer(this, 58, 15);
      this.right_gill.func_78790_a(-0.5F, -1.5F, 0.0F, 1, 3, 2, scale);
      this.right_gill.func_78793_a(-5.0F, 15.0F, -8.0F);
      this.left_gill = new ModelRenderer(this, 52, 15);
      this.left_gill.func_78790_a(-0.5F, -1.5F, 0.0F, 1, 3, 2, scale);
      this.left_gill.func_78793_a(0.0F, 15.0F, -8.0F);
   }
