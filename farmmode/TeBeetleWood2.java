...
public class TeBeetleWood2 extends TileEntity {
   ...
   public void func_145845_h() {
      if (this.field_145850_b.func_147439_a(this.field_145851_c, this.field_145848_d, this.field_145849_e) != ReqBeetleItem.BeetleWood2) {
      ...
      if (this.mother && this.father) {
         ...
         if (this.sondeley >= 24000) {
            ...
            this.sondeley = 0;
            entityworm e = new entityworm(this.field_145850_b);
            e.func_70107_b((double)this.field_145851_c, (double)this.field_145848_d, (double)this.field_145849_e);
            this.field_145850_b.func_72838_d(e);
            e.func_70903_f(true);
            e.setOwner(this.OwnerID);
