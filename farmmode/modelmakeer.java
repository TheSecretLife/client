...
public class modelmakeer extends ModelBase {
   ...
   public modelmakeer(float shadowSize) {
      this.model = (sagaobj)AssetManager.getObjModel("fantasyland:models/farm/makeer.saga");
