...
public class renderChili extends TileEntitySpecialRenderer {
   ...
   private final ModelBase Model5 = new ChiliLv5();
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      ...
      ResourceLocation textures = new ResourceLocation("fantasyland:textures/model/blockChili.png");
      if (i == 1) {
         GL11.glPushMatrix();
