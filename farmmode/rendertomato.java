...
public class rendertomato extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntity te, double x, double y, double z, float scale) {
      int i = 0;
      if (te.func_145830_o()) {
         i = te.func_145831_w().func_72805_g(te.field_145851_c, te.field_145848_d, te.field_145849_e);
      }

      ResourceLocation textures = new ResourceLocation("fantasyland:textures/model/blockTomato.png");
      if (i == 1) {
         GL11.glPushMatrix();
